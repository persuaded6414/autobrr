    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700 lg:col-span-9">
      ...
      <div className="px-6 py-4">
        ...
        <input
          ...
          type="text"
          autoComplete="true"
          className="mt-1 mb-4 block w-full border rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 border-gray-300 dark:border-gray-775 bg-gray-100 dark:bg-gray-850 dark:text-gray-100 sm:text-sm"
        />
        <label
          htmlFor="input-lines"
          className="block text-sm font-medium text-gray-600 dark:text-gray-300"

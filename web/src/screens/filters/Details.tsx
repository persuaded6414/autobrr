  ...
  return (
    <NavLink
      ...
      className={({ isActive }) => classNames(
        "transition border-b-2 whitespace-nowrap py-4 duration-3000 px-1 font-medium text-sm",
        isActive
          ? "text-blue-600 dark:text-white border-blue-600 dark:border-blue-500"
          : "text-gray-500 hover:text-blue-500 dark:hover:text-white border-transparent"
      )}
...
export function Advanced({ values }: AdvancedProps) {
  return (
    <div>
      <WarningAlert className="mt-5" text="autobrr has extensive filtering built-in - only use this if nothing else works. If you need help, please ask." />
      ...
      <CollapsableSection title="Language" subtitle="Match or ignore languages.">
      ...
      <CollapsableSection title="Release Tags" subtitle="This is the non-parsed releaseTags string from the announce.">
        <div className="grid col-span-12 gap-3">
      ...
      <CollapsableSection title="Feeds" subtitle="These options are only for Feeds such as RSS, Torznab and Newznab">
...
export function CollapsableSection({ title, subtitle, children, defaultOpen = false }: CollapsableSectionProps) {

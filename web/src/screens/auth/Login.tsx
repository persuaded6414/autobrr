...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-3">
      ...
      <div className="mx-auto w-full max-w-md rounded-lg shadow-lg">
        <div className="px-6 pt-6 pb-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-150 dark:border-gray-775">

...
const Toast: FC<Props> = ({ type, body, t }) => (
  <div className={classNames(
    ...
    "max-w-sm w-full bg-white dark:bg-gray-800 shadow-2xl rounded-lg pointer-events-auto border border-gray-250 dark:border-gray-775 overflow-hidden transition-all")}>
    <div className="p-4">
